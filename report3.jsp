...
%>
SELECT COUNT(pc.grade) AS C FROM faculty f, student s, past_classes pc, class c WHERE pc.s_ssn = s.s_ssn AND c.f_name = f.f_name AND pc.co_number = c.co_number AND c.co_number = 'cse8a' AND (pc.grade = 'C' OR pc.grade = 'C+' OR pc.grade = 'C-')

<!-- SELECT COUNT(pc.grade) AS C FROM faculty f, student s, past_classes pc, course c WHERE pc.s_ssn = s.s_ssn AND AND pc.co_number = c.co_number AND c.co_number = 'cse8a' AND f.f_name = 'Justin Bieber' AND c.quarter = 'Winter' AND (pc.grade = 'C' OR pc.grade = 'C+' OR pc.grade = 'C-') AND pc.quarter = c.quarter -->
